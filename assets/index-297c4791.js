...
${t.templateString}
`)}const Ro={imageData:Es(),shouldVerticallyCenter:!1,shouldUseCrispScaling:!1,settled:!1},qr=W`
    <div class="click-cover"></div>
`,at=Cs()({tagName:"vir-resizable-image",stateInit:Ro,hostClasses:{verticallyCenter:({state:t})=>t.shouldVerticallyCenter},styles:({hostClassSelectors:t})=>ot`
        :host {
            position: relative;
