...
`).map(c=>c.trim().replace(/,+$/,""));e(new n.urlsChange(u))})}
            ...
            ></textarea>
        `}}),et={max:{width:300,height:600},min:{width:300,height:150}};Ia({tagName:"vir-example-app",stateInit:{showConstraints:!0,imageUrls:$s(cs.get()),constraints:void 0,router:yi,urlUpdateDebounce:{promise:void 0,lastSearch:void 0}},hostClasses:{showConstraints:({state:t})=>t.showConstraints},styles:({hostClassSelectors:t})=>ot`
        :host {
            display: flex;
